...
# cap = cv.VideoCapture(args.input if args.input else 0) # Video Capture Disabled
# comment out the code below to get rid of Image Capture
if args.input:
    ...
    print("Please provide an image using --input")
    exit()
# Until here
